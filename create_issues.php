...
<div class="index__form--content">
	...
	<form>
		<input type="text" name="title" placeholder="Title Issues"/>
		<input type="text" name="context" placeholder="Context Issues"/>
		<div class="buttons index__form--content-send"><span>Send</span></div>
	</form>
