	...
	<div class="index__content-list">
		<?php
			...
			for($i=0; $i<=count($issues); $i++){
				...
				echo '<div class="index__content-list--text"><div class="index__content-list--title">Title:</div> '.$issues[$i]['title'].'</div><div class="index__content-list--text"><div class="index__content-list--title">Context:</div>'.$issues[$i]['body'].'</div><div class="line"></div>';
			}
		?>
	</div>
	<div class="full">
		<div class="buttons index__content-git--create"><span>Create issues</span></div>
	</div>
</div>
