...
<div class="index__form--content">

	<div class="index__content-git">

		<!-- Coloquei svg para ter liberdade de alterar no tamanho dela sem que perca a qualidade e criar hovers para ela -->
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="200px" height="200px" viewBox="0 0 568.034 568.034" style="enable-background:new 0 0 568.034 568.034;" xml:space="preserve">
			<g>
				<g>
	...
	<?php
		...
		$client->authenticate("1d65337ab7c96854c87240ce01bf4493e761bf4b", Github\Client::AUTH_HTTP_TOKEN);
	...
	<div class="buttons index__content-git--create"><span>Create others issues</span></div>
	<div class="buttons index__content-git--list grey"><span>List issues</span></div>
</div>
